    ...
    <div class="auth-inner my-2">
        ...
        <div class="card mb-0">
            <div class="card-body">
                ...
                <h4 class="card-title mb-1">Welcome to WMS! 👋</h4>
                ...
                <form class="auth-login-form mt-2" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-1">
                        ...
                        <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" placeholder="john@example.com" aria-describedby="email" tabindex="1" autofocus />
                        @error('email')
